...
* **`releases/v1.0.4/`** contains the default-parameter `.step` and `.stl` exports ready for slicing, along with the per-part mass breakdown (`violin_body.json`) and an Orca profile bundle (`profiles/`).
