...
SPEC = [
    ...
    ("bridge_foot_height", "float", (2.0, 10.0), "Height of the bridge feet"),
    ...
    ("bridge_string_groove_depth", "float", (0.3, 1.5), "Depth of string grooves on bridge top"),
    ("bridge_string_groove_width", "float", (2.0, 5.0), "Width of string grooves on bridge top"),
    ("bridge_string_spacing", "float", (8.0, 14.0), "Spacing between string grooves on bridge"),
    ("bridge_string_heights", "str", None, "Comma-separated heights of each string (G,D,A,E)"),
