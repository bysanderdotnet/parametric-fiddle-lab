...
SPEC = [
    ...
    ("neck_width", "float", (25.0, 40.0), "Width of the neck"),
    ...
    ("fine_tuner_radius", "float", None, "Radius of the fine tuners"),
    ("fine_tuner_height", "float", None, "Height of the fine tuners"),
