...
SPEC = [
    ...
    ("bridge_angle", "float", (-15.0, 15.0), "Angle of the bridge relative to the vertical axis"),
    ("soundpost_thickness", "float", (4.0, 10.0), "Thickness (diameter) of the soundpost"),
    ("soundpost_length", "float", (30.0, 70.0), "Length of the soundpost"),
    ...
    ("peg_hole_radius_left", "float", (3.0, 4.0), "Radius of the peg hole on the treble (left) side -- tapered 1:30"),
    ("peg_hole_radius_right", "float", (3.5, 4.5), "Radius of the peg hole on the bass (right) side -- tapered 1:30"),
    ...
    ("string_slot_width", "float", (1.5, 3.0), "Width of the tailpiece string slots for ball-end strings"),
    ("string_slot_length", "float", (4.0, 8.0), "Length of the tailpiece string slots"),
    ("string_slot_offset", "float", (3.0, 8.0), "Offset of the string slots from the tailpiece bottom edge"),
    ("chinrest_clamp_arm_width", "float", (5.0, 12.0), "Width of the chinrest clamp arm"),
    ("chinrest_clamp_thickness", "float", (2.0, 5.0), "Thickness of the chinrest clamp arm"),
    ("chinrest_clamp_depth", "float", (3.0, 8.0), "Vertical depth of the chinrest clamp wrap under the rib"),
    ("chinrest_clamp_lip_height", "float", (2.0, 5.0), "Height of the chinrest clamp lip hook under the rib edge"),
